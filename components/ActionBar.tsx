"use client";
import { Sparkles, Download, Loader2, Share2, Check, ChevronDown } from "lucide-react";
...
export default function ActionBar({
  ...
  return (
    <div className="mt-10 flex flex-col items-center gap-5">
      {/* Scale selector — always visible until enhanced */}
      {!enhancedUrl && (
      ...
      {!enhancedUrl ? (
        ...
        <div className="flex flex-col items-center gap-4 animate-in fade-in zoom-in duration-300">
          <div className="flex items-center gap-3 flex-wrap justify-center">
            ...
            >
              {copied ? <><Check size={18} className="text-emerald-400" /> Copied!</> : <><Share2 size={18} /> Share Link</>}
            </button>
